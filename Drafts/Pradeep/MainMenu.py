...
login_fetch_query="Select concat(user_firstname, ',' , user_lastname) name  from  CS6400_spr22_team103.user where email=  " + "'" + global_variables.email_text+ "'"
user_data = []
...
unacceptedswaps_text.set("Unaccepted Swaps-"+"0")
unacceptedswaps_button = Button(master,
             text=unacceptedswaps_text.get(), bg='white',fg='blue', borderless=1,height=50,width=150)
...
unratedswaps_text.set("Unrated Swaps-"+"0")
unacceptedswaps_button = Button(master,
...
searchitems_button = Button(master,
             text="Serach Items", bg='blue',fg='white', borderless=1,height=50,width=150)
searchitems_button.place(x=210,y=250)
swaphistory_button = Button(master,
             text="Swap History", bg='blue',fg='white', borderless=1,height=50,width=150,command=swaps)
