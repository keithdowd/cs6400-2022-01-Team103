...
def view_item(item_number):
  ...
  label_title_value = tk.Label(master=frame_left, text=f'{item_title}', wraplength=125, justify='left', font=(LABEL_FONT_FAMILY, LABEL_FONT_SIZE, LABEL_FONT_WEIGHT_VALUE))
